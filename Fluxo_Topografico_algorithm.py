    ...
    def _qml_slope_embrapa(categorico: bool = False) -> str:
        ...
        if categorico:
            return (
                ...
                "      <rasterTransparency/>\n"
                "      <colorPalette>\n"
                "        <paletteEntry label=\"0% – 3% (Plano)\" color=\"#2e7d32\" alpha=\"255\" value=\"1\"/>\n"
                "        <paletteEntry label=\"3% - 8% (Suave ondulado)\" color=\"#66bb6a\" alpha=\"255\" value=\"2\"/>\n"
                "        <paletteEntry label=\"8% - 20% (Ondulado)\" color=\"#fdd835\" alpha=\"255\" value=\"3\"/>\n"
                "        <paletteEntry label=\"20% - 45% (Forte ondulado)\" color=\"#fb8c00\" alpha=\"255\" value=\"4\"/>\n"
                "        <paletteEntry label=\"45% - 75% (Montanhoso)\" color=\"#e53935\" alpha=\"255\" value=\"5\"/>\n"
                "        <paletteEntry label=\"&gt; 75% (Escarpado)\" color=\"#8e24aa\" alpha=\"255\" value=\"6\"/>\n"
                "      </colorPalette>\n"
                "    </rasterrenderer>\n"
                "    <brightnesscontrast brightness=\"0\" gamma=\"1\" contrast=\"0\"/>\n"
                "    <huesaturation colorizeStrength=\"100\" invertColors=\"0\" colorizeBlue=\"128\" colorizeRed=\"255\" colorizeGreen=\"128\" colorizeOn=\"0\" grayscaleMode=\"0\" saturation=\"0\"/>\n"
        ...
        return (
            ...
            "          <item label=\"0% – 3% (Plano)\" color=\"#2e7d32\" alpha=\"255\" value=\"3\"/>\n"
            "          <item label=\"3% - 8% (Suave ondulado)\" color=\"#66bb6a\" alpha=\"255\" value=\"8\"/>\n"
            "          <item label=\"8% - 20% (Ondulado)\" color=\"#fdd835\" alpha=\"255\" value=\"20\"/>\n"
            "          <item label=\"20% - 45% (Forte ondulado)\" color=\"#fb8c00\" alpha=\"255\" value=\"45\"/>\n"
            "          <item label=\"45% - 75% (Montanhoso)\" color=\"#e53935\" alpha=\"255\" value=\"75\"/>\n"
            "          <item label=\"&gt; 75% (Escarpado)\" color=\"#8e24aa\" alpha=\"255\" value=\"inf\"/>\n"
            "        </colorrampshader>\n"
            "      </rastershader>\n"
            "    </rasterrenderer>\n"
            "    <brightnesscontrast brightness=\"0\" gamma=\"1\" contrast=\"0\"/>\n"
